...
looseModExtMuonTrackVSel4MuonAssoc = Validation.RecoMuon.MuonTrackValidator_cfi.muonTrackValidator.clone()
looseModExtMuonTrackVSel4MuonAssoc.associatormap = 'tpToLooseModExtSel4MuonAssociation'
looseModExtMuonTrackVSel4MuonAssoc.associators = ('MuonAssociationByHits',)
looseModExtMuonTrackVSel4MuonAssoc.label = ('bestMuonLooseModExt',)
looseModExtMuonTrackVSel4MuonAssoc.usetracker = True
looseModExtMuonTrackVSel4MuonAssoc.usemuon = True
looseModExtMuonTrackVSel4MuonAssoc.useMCTruth = False
looseModExtMuonTrackVSel4MuonAssoc.minRapidityTP = 0.0
looseModExtMuonTrackVSel4MuonAssoc.maxRapidityTP = 2.8
looseModExtMuonTrackVSel4MuonAssoc.min = 0.0
looseModExtMuonTrackVSel4MuonAssoc.max = 2.8
looseModExtMuonTrackVSel4MuonAssoc.nint = 28
looseModExtMuonTrackVSel4MuonAssoc.minRes = 0.0
looseModExtMuonTrackVSel4MuonAssoc.maxRes = 2.8
looseModExtMuonTrackVSel4MuonAssoc.nintRes = 28
looseModExtMuonTrackVSel4MuonAssoc.useFabsEta = True
looseModExtMuonTrackVSel4MuonAssoc.useAbsEta = True

loose2ModExtMuonTrackVSel0MuonAssoc = Validation.RecoMuon.MuonTrackValidator_cfi.muonTrackValidator.clone()
loose2ModExtMuonTrackVSel0MuonAssoc.associatormap = 'tpToLoose2ModExtSel0MuonAssociation'
loose2ModExtMuonTrackVSel0MuonAssoc.associators = ('MuonAssociationByHits',)
loose2ModExtMuonTrackVSel0MuonAssoc.label = ('bestMuonLoose2ModExt',)
loose2ModExtMuonTrackVSel0MuonAssoc.usetracker = True
loose2ModExtMuonTrackVSel0MuonAssoc.usemuon = True
loose2ModExtMuonTrackVSel0MuonAssoc.useMCTruth = False
loose2ModExtMuonTrackVSel0MuonAssoc.minRapidityTP = 0.0
loose2ModExtMuonTrackVSel0MuonAssoc.maxRapidityTP = 2.8
loose2ModExtMuonTrackVSel0MuonAssoc.min = 0.0
loose2ModExtMuonTrackVSel0MuonAssoc.max = 2.8
loose2ModExtMuonTrackVSel0MuonAssoc.nint = 28
loose2ModExtMuonTrackVSel0MuonAssoc.minRes = 0.0
loose2ModExtMuonTrackVSel0MuonAssoc.maxRes = 2.8
loose2ModExtMuonTrackVSel0MuonAssoc.nintRes = 28
loose2ModExtMuonTrackVSel0MuonAssoc.useFabsEta = True
loose2ModExtMuonTrackVSel0MuonAssoc.useAbsEta = True
...
loose2ModExtMuonTrackVSel05SimMuonAssoc = Validation.RecoMuon.MuonTrackValidator_cfi.muonTrackValidator.clone()
loose2ModExtMuonTrackVSel05SimMuonAssoc.associatormap = 'tpToLoose2ModExtSel0MuonAssociation'
loose2ModExtMuonTrackVSel05SimMuonAssoc.associators = ('MuonAssociationByHits',)
loose2ModExtMuonTrackVSel05SimMuonAssoc.label = ('bestMuonLoose2ModExt',)
loose2ModExtMuonTrackVSel05SimMuonAssoc.ptMinTP = 5.0
loose2ModExtMuonTrackVSel05SimMuonAssoc.usetracker = True
loose2ModExtMuonTrackVSel05SimMuonAssoc.usemuon = True
loose2ModExtMuonTrackVSel05SimMuonAssoc.useMCTruth = False
loose2ModExtMuonTrackVSel05SimMuonAssoc.dirName = 'Muons/RecoMuonV/MultiTrack/Cut5/'
loose2ModExtMuonTrackVSel05SimMuonAssoc.minRapidityTP = 0.0
loose2ModExtMuonTrackVSel05SimMuonAssoc.maxRapidityTP = 2.8
loose2ModExtMuonTrackVSel05SimMuonAssoc.min = 0.0
loose2ModExtMuonTrackVSel05SimMuonAssoc.max = 2.8
loose2ModExtMuonTrackVSel05SimMuonAssoc.nint = 28
loose2ModExtMuonTrackVSel05SimMuonAssoc.minRes = 0.0
loose2ModExtMuonTrackVSel05SimMuonAssoc.maxRes = 2.8
loose2ModExtMuonTrackVSel05SimMuonAssoc.nintRes = 28
loose2ModExtMuonTrackVSel05SimMuonAssoc.useFabsEta = True
loose2ModExtMuonTrackVSel05SimMuonAssoc.useAbsEta = True
...
staUpdMuonTrackVMuonAssoc.label = ('extractedSTAMuons',)
...
glbMuonInTimeTrackVMuonAssoc = Validation.RecoMuon.MuonTrackValidator_cfi.muonTrackValidator.clone()
glbMuonInTimeTrackVMuonAssoc.associatormap = 'tpToInTimeGlbMuonAssociation'
glbMuonInTimeTrackVMuonAssoc.associators = ('MuonAssociationByHits',)
glbMuonInTimeTrackVMuonAssoc.label = ('extractedInTimeGlobalMuons',)
glbMuonInTimeTrackVMuonAssoc.usetracker = True
glbMuonInTimeTrackVMuonAssoc.usemuon = True
...
me0LooseMuonTrackVMuonAssoc = Validation.RecoMuon.MuonTrackValidator_cfi.muonTrackValidator.clone()
me0LooseMuonTrackVMuonAssoc.associatormap = 'tpToME0LooseMuonMuonAssociation'
me0LooseMuonTrackVMuonAssoc.associators = ('MuonAssociationByHits',)
me0LooseMuonTrackVMuonAssoc.label = ('extractMe0LooseMuons',)
me0LooseMuonTrackVMuonAssoc.minRapidityTP = 2.0
me0LooseMuonTrackVMuonAssoc.maxRapidityTP = 2.8
me0LooseMuonTrackVMuonAssoc.usetracker = True
me0LooseMuonTrackVMuonAssoc.usemuon = False
me0LooseMuonTrackVMuonAssoc.min = 2.0
me0LooseMuonTrackVMuonAssoc.max = 2.8
me0LooseMuonTrackVMuonAssoc.nint = 8
me0LooseMuonTrackVMuonAssoc.minRes = 2.0
me0LooseMuonTrackVMuonAssoc.maxRes = 2.8
me0LooseMuonTrackVMuonAssoc.nintRes = 8
me0LooseMuonTrackVMuonAssoc.useFabsEta = True
me0LooseMuonTrackVMuonAssoc.useAbsEta = True

me0LooseMuonTrackVSim05MuonAssoc = Validation.RecoMuon.MuonTrackValidator_cfi.muonTrackValidator.clone()
me0LooseMuonTrackVSim05MuonAssoc.associatormap = 'tpToME0LooseMuonMuonAssociation'
me0LooseMuonTrackVSim05MuonAssoc.associators = ('MuonAssociationByHits',)
me0LooseMuonTrackVSim05MuonAssoc.label = ('extractMe0LooseMuons',)
me0LooseMuonTrackVSim05MuonAssoc.minRapidityTP = 2.0
me0LooseMuonTrackVSim05MuonAssoc.maxRapidityTP = 2.8
me0LooseMuonTrackVSim05MuonAssoc.ptMinTP = 5.0
me0LooseMuonTrackVSim05MuonAssoc.dirName = 'Muons/RecoMuonV/MultiTrack/Cut5/'
me0LooseMuonTrackVSim05MuonAssoc.usetracker = True
me0LooseMuonTrackVSim05MuonAssoc.usemuon = False
me0LooseMuonTrackVSim05MuonAssoc.min = 2.0
me0LooseMuonTrackVSim05MuonAssoc.max = 2.8
me0LooseMuonTrackVSim05MuonAssoc.nint = 8
me0LooseMuonTrackVSim05MuonAssoc.minRes = 2.0
me0LooseMuonTrackVSim05MuonAssoc.maxRes = 2.8
me0LooseMuonTrackVSim05MuonAssoc.nintRes = 8
me0LooseMuonTrackVSim05MuonAssoc.useFabsEta = True
me0LooseMuonTrackVSim05MuonAssoc.useAbsEta = True

me0TightMuonTrackVMuonAssoc = Validation.RecoMuon.MuonTrackValidator_cfi.muonTrackValidator.clone()
me0TightMuonTrackVMuonAssoc.associatormap = 'tpToME0TightMuonMuonAssociation'
me0TightMuonTrackVMuonAssoc.associators = ('MuonAssociationByHits',)
me0TightMuonTrackVMuonAssoc.label = ('extractMe0TightMuons',)
me0TightMuonTrackVMuonAssoc.minRapidityTP = 2.0
me0TightMuonTrackVMuonAssoc.maxRapidityTP = 2.8
me0TightMuonTrackVMuonAssoc.usetracker = True
me0TightMuonTrackVMuonAssoc.usemuon = False
me0TightMuonTrackVMuonAssoc.min = 2.0
me0TightMuonTrackVMuonAssoc.max = 2.8
me0TightMuonTrackVMuonAssoc.nint = 8
me0TightMuonTrackVMuonAssoc.minRes = 2.0
me0TightMuonTrackVMuonAssoc.maxRes = 2.8
me0TightMuonTrackVMuonAssoc.nintRes = 8
me0TightMuonTrackVMuonAssoc.useFabsEta = True
me0TightMuonTrackVMuonAssoc.useAbsEta = True

me0TightMuonTrackVSim05MuonAssoc = Validation.RecoMuon.MuonTrackValidator_cfi.muonTrackValidator.clone()
me0TightMuonTrackVSim05MuonAssoc.associatormap = 'tpToME0TightMuonMuonAssociation'
me0TightMuonTrackVSim05MuonAssoc.associators = ('MuonAssociationByHits',)
me0TightMuonTrackVSim05MuonAssoc.label = ('extractMe0TightMuons',)
me0TightMuonTrackVSim05MuonAssoc.minRapidityTP = 2.0
me0TightMuonTrackVSim05MuonAssoc.maxRapidityTP = 2.8
me0TightMuonTrackVSim05MuonAssoc.ptMinTP = 5.0
me0TightMuonTrackVSim05MuonAssoc.dirName = 'Muons/RecoMuonV/MultiTrack/Cut5/'
me0TightMuonTrackVSim05MuonAssoc.usetracker = True
me0TightMuonTrackVSim05MuonAssoc.usemuon = False
me0TightMuonTrackVSim05MuonAssoc.min = 2.0
me0TightMuonTrackVSim05MuonAssoc.max = 2.8
me0TightMuonTrackVSim05MuonAssoc.nint = 8
me0TightMuonTrackVSim05MuonAssoc.minRes = 2.0
me0TightMuonTrackVSim05MuonAssoc.maxRes = 2.8
me0TightMuonTrackVSim05MuonAssoc.nintRes = 8
me0TightMuonTrackVSim05MuonAssoc.useFabsEta = True
me0TightMuonTrackVSim05MuonAssoc.useAbsEta = True
...
#    + glbMuonInTimeTrackVMuonAssoc
    ...
    + looseModExtMuonTrackVSel4MuonAssoc
    + loose2ModExtMuonTrackVSel0MuonAssoc
    ...
    + loose2ModExtMuonTrackVSel05SimMuonAssoc
...
me0MuonValidation = cms.Sequence(
                                 extractMe0MuonsTracks_seq +
...
#                                 me0MuonTrackVMuonAssoc +
                                 ...
                                 me0TightMuonTrackVSim05MuonAssoc
                                 )
