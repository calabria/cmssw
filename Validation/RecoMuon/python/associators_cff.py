...
glbmuon2StatTiming = cms.EDFilter("MuonSelector",
    src = cms.InputTag("muons"),
    cut = cms.string("isGlobalMuon && outerTrack.hitPattern.muonStationsWithValidHits > 1 && abs(time.timeAtIpInOut) < (12.5 + abs(time.timeAtIpInOutErr))"),
    filter = cms.bool(False)
)
...
bestMuonLoose2ModExt = cms.EDProducer("MuonTrackProducer",
   muonsTag = cms.InputTag("muons"),
   inputDTRecSegment4DCollection = cms.InputTag("dt4DSegments"),
   inputCSCSegmentCollection = cms.InputTag("cscSegments"),
   vtxTag = cms.InputTag("selectedVertices"),
   selectionTags = cms.vstring('All'),
   trackType = cms.string('globalTrackLoose2ModExt')
)

bestMuonLooseModExt5 = cms.EDProducer("MuonTrackProducer",
   muonsTag = cms.InputTag("muonPt5"),
   inputDTRecSegment4DCollection = cms.InputTag("dt4DSegments"),
   inputCSCSegmentCollection = cms.InputTag("cscSegments"),
   vtxTag = cms.InputTag("selectedVertices"),
...
bestMuonTightModExt = cms.EDProducer("MuonTrackProducer",
   ...
   vtxTag = cms.InputTag("selectedVertices"),
   selectionTags = cms.vstring('All'),
   trackType = cms.string('globalTrackTightModExt')
)

bestMuonTightModExt5 = cms.EDProducer("MuonTrackProducer",
   muonsTag = cms.InputTag("muonPt5"),
   inputDTRecSegment4DCollection = cms.InputTag("dt4DSegments"),
   inputCSCSegmentCollection = cms.InputTag("cscSegments"),
   vtxTag = cms.InputTag("selectedVertices"),
...
bestMuonTightClassic = cms.EDProducer("MuonTrackProducer",
   ...
   vtxTag = cms.InputTag("selectedVertices"),
   selectionTags = cms.vstring('All'),
   trackType = cms.string('globalTrackTightClassic')
)

bestMuonTightClassic5 = cms.EDProducer("MuonTrackProducer",
   muonsTag = cms.InputTag("muonPt5"),
   inputDTRecSegment4DCollection = cms.InputTag("dt4DSegments"),
   inputCSCSegmentCollection = cms.InputTag("cscSegments"),
   vtxTag = cms.InputTag("selectedVertices"),
...
#    *bestMuonTightMod #* bestMuonTightMod5
    bestMuonLooseModExt * bestMuonLoose2ModExt * bestMuonLooseModExt5
...
extractedInTimeGlobalMuons = SimMuon.MCTruth.MuonTrackProducer_cfi.muonTrackProducer.clone()
extractedInTimeGlobalMuons.selectionTags = ('AllGlobalMuons',)
extractedInTimeGlobalMuons.trackType = "globalTrack"
extractedInTimeGlobalMuons.muonsTag = "glbmuon2StatTiming"
...
extractMe0LooseMuons = SimMuon.MCTruth.MuonTrackProducer_cfi.muonTrackProducer.clone()
extractMe0LooseMuons.selectionTags = cms.vstring('All',)
extractMe0LooseMuons.trackType = "me0MuonLoose"

extractMe0TightMuons = SimMuon.MCTruth.MuonTrackProducer_cfi.muonTrackProducer.clone()
extractMe0TightMuons.selectionTags = cms.vstring('All',)
extractMe0TightMuons.trackType = "me0MuonTight"

extractMe0MuonsTracks_seq = cms.Sequence( #extractMe0Muons *
                                          extractMe0LooseMuons *
                                          extractMe0TightMuons
                                        )
...
tpToInTimeGlbMuonAssociation = SimMuon.MCTruth.MuonAssociatorByHits_cfi.muonAssociatorByHits.clone()
...
tpToME0LooseMuonMuonAssociation = SimMuon.MCTruth.MuonAssociatorByHits_cfi.muonAssociatorByHits.clone()
tpToME0TightMuonMuonAssociation = SimMuon.MCTruth.MuonAssociatorByHits_cfi.muonAssociatorByHits.clone()
...
tpToLooseModExtSel0MuonAssociation = SimMuon.MCTruth.MuonAssociatorByHits_cfi.muonAssociatorByHits.clone()
tpToLooseModExtSel4MuonAssociation = SimMuon.MCTruth.MuonAssociatorByHits_cfi.muonAssociatorByHits.clone()
tpToLoose2ModExtSel0MuonAssociation = SimMuon.MCTruth.MuonAssociatorByHits_cfi.muonAssociatorByHits.clone()
tpToLooseModExtSelUncMuonAssociation = SimMuon.MCTruth.MuonAssociatorByHits_cfi.muonAssociatorByHits.clone()
tpToLooseModExtSel05MuonAssociation = SimMuon.MCTruth.MuonAssociatorByHits_cfi.muonAssociatorByHits.clone()

tpToTightModExtSel0MuonAssociation = SimMuon.MCTruth.MuonAssociatorByHits_cfi.muonAssociatorByHits.clone()
tpToTightModExtSelUncMuonAssociation = SimMuon.MCTruth.MuonAssociatorByHits_cfi.muonAssociatorByHits.clone()
tpToTightModExtSel05MuonAssociation = SimMuon.MCTruth.MuonAssociatorByHits_cfi.muonAssociatorByHits.clone()

tpToTightClassicSel0MuonAssociation = SimMuon.MCTruth.MuonAssociatorByHits_cfi.muonAssociatorByHits.clone()
tpToTightClassicSelUncMuonAssociation = SimMuon.MCTruth.MuonAssociatorByHits_cfi.muonAssociatorByHits.clone()
tpToTightClassicSel05MuonAssociation = SimMuon.MCTruth.MuonAssociatorByHits_cfi.muonAssociatorByHits.clone()

tpToTightClassicNoIPzSel0MuonAssociation = SimMuon.MCTruth.MuonAssociatorByHits_cfi.muonAssociatorByHits.clone()
tpToTightModExtSimSel0MuonAssociation = SimMuon.MCTruth.MuonAssociatorByHits_cfi.muonAssociatorByHits.clone()
...
tpToStaUpdMuonAssociation.tracksTag = 'extractedSTAMuons'
...
tpToInTimeGlbMuonAssociation.tpTag = 'mix:MergedTrackTruth'
tpToInTimeGlbMuonAssociation.tracksTag = 'extractedInTimeGlobalMuons'
tpToInTimeGlbMuonAssociation.UseTracker = True
tpToInTimeGlbMuonAssociation.UseMuon = True
...
tpToME0LooseMuonMuonAssociation.tpTag = 'mix:MergedTrackTruth'
tpToME0LooseMuonMuonAssociation.tracksTag = 'extractMe0LooseMuons'
tpToME0LooseMuonMuonAssociation.UseTracker = True
tpToME0LooseMuonMuonAssociation.UseMuon = False

tpToME0TightMuonMuonAssociation.tpTag = 'mix:MergedTrackTruth'
tpToME0TightMuonMuonAssociation.tracksTag = 'extractMe0TightMuons'
tpToME0TightMuonMuonAssociation.UseTracker = True
tpToME0TightMuonMuonAssociation.UseMuon = False
...
tpToLooseModExtSel0MuonAssociation.tpTag = 'mix:MergedTrackTruth'
tpToLooseModExtSel0MuonAssociation.tracksTag = 'bestMuonLooseModExt'
tpToLooseModExtSel0MuonAssociation.UseTracker = True
tpToLooseModExtSel0MuonAssociation.UseMuon = True
#tpToLooseModExtSel0MuonAssociation.EfficiencyCut_track = cms.double(0.5)
#tpToLooseModExtSel0MuonAssociation.PurityCut_track = cms.double(0.75)
#tpToLooseModExtSel0MuonAssociation.EfficiencyCut_muon = cms.double(0.5)
#tpToLooseModExtSel0MuonAssociation.PurityCut_muon = cms.double(0.75)
tpToLooseModExtSel0MuonAssociation.acceptOneStubMatchings = False
#tpToLooseModExtSel0MuonAssociation.includeZeroHitMuons = False

tpToLooseModExtSel4MuonAssociation.tpTag = 'mix:MergedTrackTruth'
tpToLooseModExtSel4MuonAssociation.tracksTag = 'bestMuonLooseModExt'
tpToLooseModExtSel4MuonAssociation.UseTracker = True
tpToLooseModExtSel4MuonAssociation.UseMuon = True
#tpToLooseModExtSel4MuonAssociation.EfficiencyCut_track = cms.double(0.5)
#tpToLooseModExtSel4MuonAssociation.PurityCut_track = cms.double(0.75)
#tpToLooseModExtSel4MuonAssociation.EfficiencyCut_muon = cms.double(0.5)
#tpToLooseModExtSel4MuonAssociation.PurityCut_muon = cms.double(0.75)
#tpToLooseModExtSel4MuonAssociation.acceptOneStubMatchings = False
#tpToLooseModExtSel4MuonAssociation.includeZeroHitMuons = False

tpToLoose2ModExtSel0MuonAssociation.tpTag = 'mix:MergedTrackTruth'
tpToLoose2ModExtSel0MuonAssociation.tracksTag = 'bestMuonLoose2ModExt'
tpToLoose2ModExtSel0MuonAssociation.UseTracker = True
tpToLoose2ModExtSel0MuonAssociation.UseMuon = True
#tpToLoose2ModExtSel0MuonAssociation.EfficiencyCut_track = cms.double(0.5)
#tpToLoose2ModExtSel0MuonAssociation.PurityCut_track = cms.double(0.75)
#tpToLoose2ModExtSel0MuonAssociation.EfficiencyCut_muon = cms.double(0.5)
#tpToLoose2ModExtSel0MuonAssociation.PurityCut_muon = cms.double(0.75)
tpToLoose2ModExtSel0MuonAssociation.acceptOneStubMatchings = False
#tpToLoose2ModExtSel0MuonAssociation.includeZeroHitMuons = False

tpToLooseModExtSelUncMuonAssociation.tpTag = 'mix:MergedTrackTruth'
tpToLooseModExtSelUncMuonAssociation.tracksTag = 'bestMuonLooseModExt'
tpToLooseModExtSelUncMuonAssociation.UseTracker = False
tpToLooseModExtSelUncMuonAssociation.UseMuon = True
#tpToLooseModExtSelUncMuonAssociation.EfficiencyCut_track = cms.double(0.5)
#tpToLooseModExtSelUncMuonAssociation.PurityCut_track = cms.double(0.75)
#tpToLooseModExtSelUncMuonAssociation.EfficiencyCut_muon = cms.double(0.5)
#tpToLooseModExtSelUncMuonAssociation.PurityCut_muon = cms.double(0.75)
tpToLooseModExtSelUncMuonAssociation.acceptOneStubMatchings = False
#tpToLooseModExtSelUncMuonAssociation.includeZeroHitMuons = False

tpToLooseModExtSel05MuonAssociation.tpTag = 'mix:MergedTrackTruth'
tpToLooseModExtSel05MuonAssociation.tracksTag = 'bestMuonLooseModExt5'
tpToLooseModExtSel05MuonAssociation.UseTracker = True
tpToLooseModExtSel05MuonAssociation.UseMuon = True
#tpToLooseModExtSel05MuonAssociation.EfficiencyCut_track = cms.double(0.5)
#tpToLooseModExtSel05MuonAssociation.PurityCut_track = cms.double(0.75)
#tpToLooseModExtSel05MuonAssociation.EfficiencyCut_muon = cms.double(0.5)
#tpToLooseModExtSel05MuonAssociation.PurityCut_muon = cms.double(0.75)
tpToLooseModExtSel05MuonAssociation.acceptOneStubMatchings = False
#tpToLooseModExtSel05MuonAssociation.includeZeroHitMuons = False
...
#tpToTightModExtSel0MuonAssociation.PurityCut_track = cms.double(0.75)
#tpToTightModExtSel0MuonAssociation.EfficiencyCut_muon = cms.double(0.5)
#tpToTightModExtSel0MuonAssociation.PurityCut_muon = cms.double(0.75)
tpToTightModExtSel0MuonAssociation.acceptOneStubMatchings = False
...
#tpToTightModExtSelUncMuonAssociation.PurityCut_track = cms.double(0.75)
#tpToTightModExtSelUncMuonAssociation.EfficiencyCut_muon = cms.double(0.5)
#tpToTightModExtSelUncMuonAssociation.PurityCut_muon = cms.double(0.75)
tpToTightModExtSelUncMuonAssociation.acceptOneStubMatchings = False
...
#tpToTightModExtSel05MuonAssociation.PurityCut_track = cms.double(0.75)
#tpToTightModExtSel05MuonAssociation.EfficiencyCut_muon = cms.double(0.5)
#tpToTightModExtSel05MuonAssociation.PurityCut_muon = cms.double(0.75)
tpToTightModExtSel05MuonAssociation.acceptOneStubMatchings = False
#tpToTightModExtSel05MuonAssociation.includeZeroHitMuons = False

tpToTightModExtSimSel0MuonAssociation.tpTag = 'mix:MergedTrackTruth'
tpToTightModExtSimSel0MuonAssociation.tracksTag = 'bestMuonTightModExtSim'
tpToTightModExtSimSel0MuonAssociation.UseTracker = True
tpToTightModExtSimSel0MuonAssociation.UseMuon = True
#tpToTightModExtSimSel0MuonAssociation = cms.double(0.5)
#tpToTightModExtSimSel0MuonAssociation = cms.double(0.75)
#tpToTightModExtSimSel0MuonAssociation = cms.double(0.5)
#tpToTightModExtSimSel0MuonAssociation = cms.double(0.75)
tpToTightModExtSimSel0MuonAssociation.acceptOneStubMatchings = False
#tpToTightModExtSimSel0MuonAssociation = False

#####################################################################################################

tpToTightClassicSel0MuonAssociation.tpTag = 'mix:MergedTrackTruth'
tpToTightClassicSel0MuonAssociation.tracksTag = 'bestMuonTightClassic'
tpToTightClassicSel0MuonAssociation.UseTracker = True
tpToTightClassicSel0MuonAssociation.UseMuon = True
#tpToTightClassicSel0MuonAssociation.EfficiencyCut_track = cms.double(0.5)
#tpToTightClassicSel0MuonAssociation.PurityCut_track = cms.double(0.75)
#tpToTightClassicSel0MuonAssociation.EfficiencyCut_muon = cms.double(0.5)
#tpToTightClassicSel0MuonAssociation.PurityCut_muon = cms.double(0.75)
tpToTightClassicSel0MuonAssociation.acceptOneStubMatchings = False
#tpToTightClassicSel0MuonAssociation.includeZeroHitMuons = False

tpToTightClassicSelUncMuonAssociation.tpTag = 'mix:MergedTrackTruth'
tpToTightClassicSelUncMuonAssociation.tracksTag = 'bestMuonTightClassic'
tpToTightClassicSelUncMuonAssociation.UseTracker = False
tpToTightClassicSelUncMuonAssociation.UseMuon = True
#tpToTightClassicSelUncMuonAssociation.EfficiencyCut_track = cms.double(0.5)
#tpToTightClassicSelUncMuonAssociation.PurityCut_track = cms.double(0.75)
#tpToTightClassicSelUncMuonAssociation.EfficiencyCut_muon = cms.double(0.5)
#tpToTightClassicSelUncMuonAssociation.PurityCut_muon = cms.double(0.75)
tpToTightClassicSelUncMuonAssociation.acceptOneStubMatchings = False
#tpToTightClassicSelUncMuonAssociation.includeZeroHitMuons = False

tpToTightClassicSel05MuonAssociation.tpTag = 'mix:MergedTrackTruth'
tpToTightClassicSel05MuonAssociation.tracksTag = 'bestMuonTightClassic5'
tpToTightClassicSel05MuonAssociation.UseTracker = True
tpToTightClassicSel05MuonAssociation.UseMuon = True
#tpToTightClassicSel05MuonAssociation.EfficiencyCut_track = cms.double(0.5)
#tpToTightClassicSel05MuonAssociation.PurityCut_track = cms.double(0.75)
#tpToTightClassicSel05MuonAssociation.EfficiencyCut_muon = cms.double(0.5)
#tpToTightClassicSel05MuonAssociation.PurityCut_muon = cms.double(0.75)
tpToTightClassicSel05MuonAssociation.acceptOneStubMatchings = False
#tpToTightClassicSel05MuonAssociation.includeZeroHitMuons = False

tpToTightClassicNoIPzSel0MuonAssociation.tpTag = 'mix:MergedTrackTruth'
tpToTightClassicNoIPzSel0MuonAssociation.tracksTag = 'bestMuonTightClassicNoIPz'
tpToTightClassicNoIPzSel0MuonAssociation.UseTracker = True
tpToTightClassicNoIPzSel0MuonAssociation.UseMuon = True
#tpToTightClassicNoIPzSel0MuonAssociation.EfficiencyCut_track = cms.double(0.5)
#tpToTightClassicNoIPzSel0MuonAssociation.PurityCut_track = cms.double(0.75)
#tpToTightClassicNoIPzSel0MuonAssociation.EfficiencyCut_muon = cms.double(0.5)
#tpToTightClassicNoIPzSel0MuonAssociation.PurityCut_muon = cms.double(0.75)
tpToTightClassicNoIPzSel0MuonAssociation.acceptOneStubMatchings = False
#tpToTightClassicNoIPzSel0MuonAssociation.includeZeroHitMuons = False
...
#    +tpToLooseModSel0MuonAssociation
    ...
    +tpToLooseModExtSel4MuonAssociation
    +tpToLoose2ModExtSel0MuonAssociation
