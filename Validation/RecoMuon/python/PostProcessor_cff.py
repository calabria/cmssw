...
postProcessorMuonMultiTrack = DQMEDHarvester("DQMGenericClient",
    ...
    "efficPt_24 'Efficiency vs p_{T}' num_assoc(simToReco)_pT_24 num_simul_pT_24",
    "efficPt_28 'Efficiency vs p_{T}' num_assoc(simToReco)_pT_28 num_simul_pT_28",
    "efficP 'Efficiency vs p' num_assoc(simToReco)_p num_simul_p",
    "efficP_24 'Efficiency vs p' num_assoc(simToReco)_p_24 num_simul_p_24",
    "efficP_28 'Efficiency vs p' num_assoc(simToReco)_p_28 num_simul_p_28",
    ...
    "fakeratePt_24 'Fake rate vs p_{T}' num_assoc(recoToSim)_pT_24 num_reco_pT_24 fake",
    "fakeratePt_28 'Fake rate vs p_{T}' num_assoc(recoToSim)_pT_28 num_reco_pT_28 fake",
    "fakerateP 'Fake rate vs p' num_assoc(recoToSim)_p num_reco_p fake",
    "fakerateP_24 'Fake rate vs p' num_assoc(recoToSim)_p_24 num_reco_p_24 fake",
    "fakerateP_28 'Fake rate vs p' num_assoc(recoToSim)_p_28 num_reco_p_28 fake",

    "fakeratePt_Sgn 'Fake rate vs p_{T}' num_assoc(recoToSim)_pT_SgnMu num_reco_pT fake",
    "fakeratePt_Sgn_24 'Fake rate vs p_{T}' num_assoc(recoToSim)_pT_SgnMu_24 num_reco_pT_24 fake",
    "fakeratePt_Sgn_28 'Fake rate vs p_{T}' num_assoc(recoToSim)_pT_SgnMu_28 num_reco_pT_28 fake",
    "fakerateP_Sgn 'Fake rate vs p' num_assoc(recoToSim)_p_SgnMu num_reco_p fake",
    "fakerateP_Sgn_24 'Fake rate vs p' num_assoc(recoToSim)_p_SgnMu_24 num_reco_p_24 fake",
    "fakerateP_Sgn_28 'Fake rate vs p' num_assoc(recoToSim)_p_SgnMu_28 num_reco_p_28 fake",
