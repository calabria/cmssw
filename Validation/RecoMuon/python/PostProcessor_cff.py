...
postProcessorMuonMultiTrack = cms.EDAnalyzer("DQMGenericClient",
    ...
    resolution = cms.vstring("cotThetares_vs_eta '#sigma(cot(#theta)) vs #eta' cotThetares_vs_eta",
                             ...
                             "invptres_vs_eta '#sigma(1/p_{T}) vs #eta' ptres_vs_eta",
                             "invptres_vs_phi '#sigma(1/p_{T}) vs #phi' ptres_vs_phi",
                             "invptres_vs_pt '#sigma(1/p_{T}) vs p_{T}' ptres_vs_pt",
                             "qOverPtres_vs_eta '#sigma(q/p_{T}) vs #eta' ptres_vs_eta",
                             "qOverPtres_vs_phi '#sigma(q/p_{T}) vs #phi' ptres_vs_phi",
                             "qOverPtres_vs_pt '#sigma(q/p_{T}) vs p_{T}' ptres_vs_pt",
...
postProcessorMuonMultiTrackComp = cms.EDAnalyzer("DQMGenericClient",
    ...
    "Eff_GlbTk_Eta_pyChi2 'Eff_{GLB,TK} vs #eta' extractedGlobalMuons_AssociatorByChi2/effic general_tpToTkmuAssociation/effic",
    "Eff_GlbTk_Pt_pyChi2 'Eff_{GLB,TK} vs p_{T}' extractedGlobalMuons_AssociatorByChi2/efficPt general_tpToTkmuAssociation/efficPt",
    "Eff_GlbTk_Hit_pyChi2 'Eff_{GLB,TK} vs n Hits' extractedGlobalMuons_AssociatorByChi2/effic_vs_hit general_tpToTkmuAssociation/effic_vs_hit",
    "Eff_GlbSta_Eta_pyChi2 'Eff_{GLB,STA} vs #eta' extractedGlobalMuons_AssociatorByChi2/effic standAloneMuons_UpdatedAtVtx_AssociatorByChi2/effic",
    "Eff_GlbSta_Pt_pyChi2 'Eff_{GLB,STA} vs p_{T}' extractedGlobalMuons_AssociatorByChi2/efficPt standAloneMuons_UpdatedAtVtx_AssociatorByChi2/efficPt",
    "Eff_GlbSta_Hit_pyChi2 'Eff_{GLB,STA} vs n Hits' extractedGlobalMuons_AssociatorByChi2/effic_vs_hit standAloneMuons_UpdatedAtVtx_AssociatorByChi2/effic_vs_hit",
    ),
