...
config = config()
config.General.requestName = 'Val_900_pre4_RUN2_7'
config.General.workArea = 'crabProjects_VAL_RUN2_7'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName ='Val_Run2.py'
config.Data.inputDataset='/RelValZMM_13/CMSSW_9_0_0_pre4-90X_mcRun2_asymptotic_v1-v1/GEN-SIM-RECO'
