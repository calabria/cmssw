...
# with command line options: FlatRandomPtAndD0GunProducer_cfi --conditions auto:run2_mc -n 10 --era Phase2 --eventcontent FEVTDEBUG -s GEN,SIM --datatier GEN-SIM --beamspot Realistic50ns13TeVCollision --customise SLHCUpgradeSimulations/Configuration/combinedCustoms.cust_2023LReco --geometry Extended2023LReco --no_exec --fileout out_sim.root
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('FlatRandomPtAndD0GunProducer_cfi nevts:10'),
