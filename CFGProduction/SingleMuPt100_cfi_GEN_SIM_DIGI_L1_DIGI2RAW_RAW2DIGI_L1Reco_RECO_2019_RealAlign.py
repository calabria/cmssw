...
# with command line options: SingleMuPt100_cfi -s GEN,SIM,DIGI:pdigi_valid,L1,DIGI2RAW,RAW2DIGI,L1Reco,RECO --conditions DES19_62_V8::All --magField 38T_PostLS1 --datatier GEN-SIM-DIGI-RAW-RECO --geometry Extended2019 --customise SLHCUpgradeSimulations/Configuration/combinedCustoms.cust_2019WithGem --eventcontent FEVTDEBUG -n 100 --no_exec --fileout out_reco.root
