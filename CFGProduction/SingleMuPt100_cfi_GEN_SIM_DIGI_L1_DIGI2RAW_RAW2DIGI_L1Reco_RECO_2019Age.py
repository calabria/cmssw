...
# with command line options: SingleMuPt100_cfi -s GEN,SIM,DIGI:pdigi_valid,L1,DIGI2RAW,RAW2DIGI,L1Reco,RECO --conditions PH1_1K_FB_V1::All --magField 38T_PostLS1 --datatier GEN-SIM-DIGI-RAW-RECO --geometry Extended2019 --customise SLHCUpgradeSimulations/Configuration/combinedCustoms.cust_2019WithGem --eventcontent FEVTDEBUG -n 100 --no_exec --fileout out_reco.root
...
process.GlobalTag = GlobalTag(process.GlobalTag, 'PH1_1K_FB_V1::All', '')
